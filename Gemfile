...
gem 'opal-webpack-loader', '>= 0.9.4'

gem 'opal-autoloader', '~> 0.1.0'
gem 'isomorfeus-redux', '~> 4.0.11'
gem 'isomorfeus-speednode', '~> 0.2.10'
gem 'isomorfeus-react', '>= 16.9.5'
gem 'isomorfeus-policy', '~> 1.0.0.epsilon3'
gem 'isomorfeus-transport', '~> 1.0.0.epsilon3'
gem 'isomorfeus-i18n', '~> 1.0.0.epsilon3'
gem 'isomorfeus-data', '~> 1.0.0.epsilon3'
gem 'isomorfeus-operation', '~> 1.0.0.epsilon3'
