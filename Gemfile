...
gem 'isomorfeus-react', '>= 16.9.18'
gem 'isomorfeus-policy', '~> 1.0.0.zeta3'
gem 'isomorfeus-transport', '~> 1.0.0.zeta3'
gem 'isomorfeus-i18n', '~> 1.0.0.zeta3'
gem 'isomorfeus-data', '~> 1.0.0.zeta3'
gem 'isomorfeus-operation', '~> 1.0.0.zeta3'
