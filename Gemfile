...
gem 'isomorfeus-policy', '~> 1.0.0.zeta4'
gem 'isomorfeus-transport', '~> 1.0.0.zeta4'
gem 'isomorfeus-i18n', '~> 1.0.0.zeta4'
gem 'isomorfeus-data', '~> 1.0.0.zeta4'
gem 'isomorfeus-operation', '~> 1.0.0.zeta4'
